...
export function ClassicTemplate({ data, colorScheme }: TemplateProps) {
  const { basicInfo, strengths, workExperience, projectExperience } = data

  return (
    <div className="resume-tpl" style={{ '--tpl-primary': colorScheme.primary, '--tpl-secondary': colorScheme.secondary, '--tpl-accent': colorScheme.accent } as React.CSSProperties}>
